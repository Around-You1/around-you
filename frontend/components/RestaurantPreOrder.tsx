            ...
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                <label className="flex flex-col gap-1 text-xs text-muted-foreground">
                  Preferred date
                  <input type="date" className="w-full min-w-0 border border-border rounded-md px-3 py-2 text-sm text-foreground"
                    value={date} onChange={(e) => setDate(e.target.value)} />
                </label>
                <label className="flex flex-col gap-1 text-xs text-muted-foreground">
                  Preferred time
                  <input type="time" className="w-full min-w-0 border border-border rounded-md px-3 py-2 text-sm text-foreground"
