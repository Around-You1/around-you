...
export default function PartnerCategoryMetrics({ title, icon: Icon, color, stats }: PartnerCategoryMetricsProps) {
  ...
  return (
    <Card className="overflow-hidden border-l-2 transition-all hover:shadow-lg" style={{ borderLeftColor: color }}>
      ...
      <CardContent className="space-y-0 pb-1.5 pt-0.5 px-2.5">
        <div className="space-y-0.5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1">
              <Badge
                variant="outline"
                className="bg-green-50 text-green-700 border-green-200 dark:bg-green-950 dark:text-green-300 dark:border-green-800 text-[9px] px-1 py-0 h-3.5 leading-none"
              >
                Active
              </Badge>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1">
              <Badge
                variant="outline"
                className="bg-red-50 text-red-700 border-red-200 dark:bg-red-950 dark:text-red-300 dark:border-red-800 text-[9px] px-1 py-0 h-3.5 leading-none"
              >
                Inactive
              </Badge>
              <span className="text-xs font-semibold text-red-700 dark:text-red-400 leading-none">
                {stats.inactiveCount}
              </span>
            </div>
            <div className="text-[9px] text-muted-foreground">
