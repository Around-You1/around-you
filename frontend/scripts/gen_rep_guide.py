...
- **Charity** — enter the charity the partner nominates: its **name, address and contact number**. Around You reviews the nominations each month (grouped by province) and a percentage of the total income goes to a charity we deem fit.
